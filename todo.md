...
- [x] 实现HINT智能提示功能
- [x] 添加AI对话气泡
- [x] 实现Move History完整历史记录
- [x] 添加Table Talk聊天功能
- [x] 实现游戏速度控制（x0.125-x8）
- [x] 优化玩家信息展示（头像+角色）
- [x] 添加游戏暂停/继续功能
...
## UI优化
- [x] 优化手牌排列方式，确保所有牌清晰可见
- [x] 在叫地主后显示底牌
- [x] 调整扇形手牌的间距和角度

## Bug修复 - 首次出牌
- [x] 修复首次出牌时错误报"Cannot beat last played cards"
- [x] 检查lastPlayedCards的初始状态
- [x] 确保首次出牌不进行牌型比较
- [x] 修复连续2次pass后，下一个玩家应该可以自由出牌的逻辑
...
## Bug修复 - 紧急
- [x] 修复手牌显示不全问题：调整重叠比例从35%到50%，扩大maxWidth从900px到1100px
- [x] 修复出牌后AI思考时错误提示"打不过对方"：前端验证逻辑增加新一轮检测
